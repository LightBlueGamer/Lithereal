package org.lithereal.forge.item.custom.ability;
...
public class ForgeAbilityKnife extends KnifeItem implements AbilityItem {
    final Ability ability;
    public ForgeAbilityKnife(Ability ability, Tier tier, Properties properties) {
