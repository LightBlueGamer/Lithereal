...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(ModItems.WITHERING_LITHERITE_HELMET.get())
                ...
                .save(consumer);
        ShapedRecipeBuilder.shaped(ModItems.WITHERING_LITHERITE_CHESTPLATE.get())
                .define('L', ModItems.WITHERING_LITHERITE_CRYSTAL.get())
                .pattern("L L")
                .pattern("LLL")
                .pattern("LLL")
                .unlockedBy("has_withering_litherite", inventoryTrigger(ItemPredicate.Builder.item()
                        .of(ModItems.WITHERING_LITHERITE_CRYSTAL.get()).build()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(ModItems.WITHERING_LITHERITE_LEGGINGS.get())
                .define('L', ModItems.WITHERING_LITHERITE_CRYSTAL.get())
                .pattern("LLL")
                .pattern("L L")
                .pattern("L L")
                .unlockedBy("has_withering_litherite", inventoryTrigger(ItemPredicate.Builder.item()
                        .of(ModItems.WITHERING_LITHERITE_CRYSTAL.get()).build()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(ModItems.WITHERING_LITHERITE_BOOTS.get())
                .define('L', ModItems.WITHERING_LITHERITE_CRYSTAL.get())
                .pattern("L L")
                .pattern("L L")
                .unlockedBy("has_withering_litherite", inventoryTrigger(ItemPredicate.Builder.item()
        ...
        ShapedRecipeBuilder.shaped(ModItems.LITHERITE_SWORD.get())
                ...
                .unlockedBy("has_litherite", inventoryTrigger(ItemPredicate.Builder.item()
                        .of(ModItems.LITHERITE_CRYSTAL.get()).build()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(ModItems.WITHERING_LITHERITE_SWORD.get())
                .define('L', ModItems.WITHERING_LITHERITE_CRYSTAL.get())
                .define('S', Tags.Items.RODS_WOODEN)
                .pattern("L")
                .pattern("L")
        ...
        ShapedRecipeBuilder.shaped(ModItems.LITHERITE_PICKAXE.get())
                ...
                .unlockedBy("has_litherite", inventoryTrigger(ItemPredicate.Builder.item()
                        .of(ModItems.LITHERITE_CRYSTAL.get()).build()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(ModItems.WITHERING_LITHERITE_PICKAXE.get())
                .define('L', ModItems.WITHERING_LITHERITE_CRYSTAL.get())
                .define('S', Tags.Items.RODS_WOODEN)
                .pattern("LLL")
                .pattern(" S ")
        ...
        ShapedRecipeBuilder.shaped(ModItems.LITHERITE_AXE.get())
                ...
                .unlockedBy("has_litherite", inventoryTrigger(ItemPredicate.Builder.item()
                        .of(ModItems.LITHERITE_CRYSTAL.get()).build()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(ModItems.WITHERING_LITHERITE_AXE.get())
                .define('L', ModItems.WITHERING_LITHERITE_CRYSTAL.get())
                .define('S', Tags.Items.RODS_WOODEN)
                .pattern("LL")
                .pattern("LS")
        ...
        ShapedRecipeBuilder.shaped(ModItems.LITHERITE_SHOVEL.get())
                ...
                .unlockedBy("has_litherite", inventoryTrigger(ItemPredicate.Builder.item()
                        .of(ModItems.LITHERITE_CRYSTAL.get()).build()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(ModItems.WITHERING_LITHERITE_SHOVEL.get())
                .define('L', ModItems.WITHERING_LITHERITE_CRYSTAL.get())
                .define('S', Tags.Items.RODS_WOODEN)
                .pattern("L")
                .pattern("S")
        ...
        ShapedRecipeBuilder.shaped(ModItems.LITHERITE_HOE.get())
                ...
                .unlockedBy("has_litherite", inventoryTrigger(ItemPredicate.Builder.item()
                        .of(ModItems.LITHERITE_CRYSTAL.get()).build()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(ModItems.WITHERING_LITHERITE_HOE.get())
                .define('L', ModItems.LITHERITE_CRYSTAL.get())
                .define('S', Tags.Items.RODS_WOODEN)
                .pattern("LL")
                .pattern(" S")
