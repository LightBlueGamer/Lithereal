...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context, LITHERITE_ORE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(ModConfiguredFeatures.LITHERITE_ORE_KEY),
    ...
    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, new Identifier(Lithereal.MOD_ID, name));
    }
