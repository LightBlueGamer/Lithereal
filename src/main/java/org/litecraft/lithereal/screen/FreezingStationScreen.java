...
public class FreezingStationScreen extends AbstractContainerScreen<FreezingStationMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        guiGraphics.blit(new ResourceLocation("lithereal:freezing_station_screen"), x, y, 0, 0, imageWidth, imageHeight);
    ...
    private void renderProgressArrow(PoseStack pPoseStack, int x, int y, GuiGraphics guiGraphics) {
        if(menu.isCrafting()) {
            guiGraphics.blit(new ResourceLocation("lithereal:freezing_station_screen"), x + 96, y + 34, 178, 1, menu.getScaledProgress(), 15);
        }
    }
