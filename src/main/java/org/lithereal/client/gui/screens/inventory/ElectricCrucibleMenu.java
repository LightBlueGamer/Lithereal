...
public class ElectricCrucibleMenu extends AbstractContainerMenu {
    ...
    public ElectricCrucibleMenu(int id, Inventory inv, RegistryFriendlyByteBuf buf) {
        this(id, inv, buf.readBlockPos());
    }

    public ElectricCrucibleMenu(int id, Inventory inv, BlockPos pos) {
        this(id, inv, inv.player.level().getBlockEntity(pos));
    }

    public ElectricCrucibleMenu(int id, Inventory inv, BlockEntity entity) {
        super(ModMenuTypes.ELECTRIC_CRUCIBLE_MENU.get(), id);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.ELECTRIC_CRUCIBLE.get());
    }
