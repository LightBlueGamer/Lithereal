...
public class FireCrucibleMenu extends AbstractContainerMenu {
    ...
    public FireCrucibleMenu(int id, Inventory inv, RegistryFriendlyByteBuf buf) {
        this(id, inv, buf.readBlockPos());
    }

    public FireCrucibleMenu(int id, Inventory inv, BlockPos pos) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.FIRE_CRUCIBLE.get());
    }
