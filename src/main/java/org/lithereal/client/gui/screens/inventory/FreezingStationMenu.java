...
public class FreezingStationMenu extends AbstractContainerMenu {
    ...
    public FreezingStationMenu(int id, Inventory inv, RegistryFriendlyByteBuf buf) {
        this(id, inv, buf.readBlockPos());
    }

    public FreezingStationMenu(int id, Inventory inv, BlockPos pos) {
        this(id, inv, inv.player.level().getBlockEntity(pos));
    }

    public FreezingStationMenu(int id, Inventory inv, BlockEntity entity) {
        super(ModMenuTypes.FREEZING_STATION_MENU.get(), id);
