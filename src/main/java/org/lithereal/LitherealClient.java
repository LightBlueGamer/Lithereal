...
public class LitherealClient {
    ...
    private static void registerItemsToBuildingBlocksTab() {
        CreativeTabRegistry.append(ModCreativeTabs.BUILDING_BLOCKS_TAB, ModItems.LITHER_TORCH.get(),
                ...
                ModStoneBlocks.ETHERSTONE_BUTTON.get(),
                ModStoneBlocks.ETHERSTONE_PRESSURE_PLATE.get(),
                ...
                ModStoneBlocks.POLISHED_ETHERSTONE_BUTTON.get(),
                ModStoneBlocks.POLISHED_ETHERSTONE_PRESSURE_PLATE.get(),
                ModStoneBlocks.CHISELED_ETHERSTONE.get(),
                ModStoneBlocks.CRACKED_ETHERSTONE_BRICKS.get(),
                ...
                ModStoneBlocks.ETHERSTONE_BRICK_BUTTON.get(),
                ModStoneBlocks.ETHERSTONE_BRICK_PRESSURE_PLATE.get(),
                ...
                ModStoneBlocks.CRACKED_POLISHED_PAILITE_BRICKS.get(),
                ...
                ModStoneBlocks.LUMINITE_BUTTON.get(),
                ModStoneBlocks.LUMINITE_PRESSURE_PLATE.get(),
                ...
                ModStoneBlocks.POLISHED_LUMINITE_BUTTON.get(),
                ModStoneBlocks.POLISHED_LUMINITE_PRESSURE_PLATE.get(),
                ModStoneBlocks.CHISELED_LUMINITE_BRICKS.get(),
                ModStoneBlocks.CRACKED_LUMINITE_BRICKS.get(),
                ModStoneBlocks.LUMINITE_BRICKS.get(),
                ModStoneBlocks.LUMINITE_BRICK_SLAB.get(),
                ModStoneBlocks.LUMINITE_BRICK_STAIRS.get(),
                ModStoneBlocks.LUMINITE_BRICK_WALL.get(),
                ModStoneBlocks.LUMINITE_BRICK_BUTTON.get(),
                ModStoneBlocks.LUMINITE_BRICK_PRESSURE_PLATE.get(),
                ...
                ModStoneBlocks.VERDONE_BUTTON.get(),
                ModStoneBlocks.VERDONE_PRESSURE_PLATE.get(),
                ...
                ModStoneBlocks.POLISHED_VERDONE_BUTTON.get(),
                ModStoneBlocks.POLISHED_VERDONE_PRESSURE_PLATE.get(),
                ModStoneBlocks.CHISELED_VERDONE_BRICKS.get(),
                ModStoneBlocks.CRACKED_VERDONE_BRICKS.get(),
                ModStoneBlocks.VERDONE_BRICKS.get(),
                ModStoneBlocks.VERDONE_BRICK_SLAB.get(),
                ModStoneBlocks.VERDONE_BRICK_STAIRS.get(),
                ModStoneBlocks.VERDONE_BRICK_WALL.get(),
                ModStoneBlocks.VERDONE_BRICK_BUTTON.get(),
                ModStoneBlocks.VERDONE_BRICK_PRESSURE_PLATE.get(),
    ...
    private static void registerItemsToNaturalTab() {
        CreativeTabRegistry.append(ModCreativeTabs.NATURAL_BLOCKS_TAB, ModOreBlocks.LITHERITE_ORE,
                ...
                ModOreBlocks.PHANTOM_DIAMOND_ORE,
                ModOreBlocks.PHANTOM_QUARTZ_ORE,
                ...
                ModVegetationBlocks.PHANTOM_ROSE,
                ModVegetationBlocks.PHANTOM_ICE_FLOWER,
                ModVegetationBlocks.PHANTOM_ROSE_ETHEREAL_CORE,
    ...
    private static void registerItemsToMaterialsTab() {
        ...
        CreativeTabRegistry.append(ModCreativeTabs.MATERIALS_TAB, ModRawMaterialItems.CHARGED_LITHERITE_CRYSTAL.get(),
                ...
                ModStorageBlocks.PHANTOM_DIAMOND_BLOCK.get(),
    ...
    private static void registerItemsToCombatTab() {
        ...
        CreativeTabRegistry.append(ModCreativeTabs.COMBAT_TAB, ModToolItems.LITHERITE_SWORD,
                ...
                ModToolItems.BURNING_LITHERITE_SPEAR,
                ModToolItems.BURNING_LITHERITE_AXE,
                ...
                ModToolItems.SMOLDERING_LITHERITE_SPEAR,
                ModToolItems.SMOLDERING_LITHERITE_AXE,
                ...
                ModToolItems.FROZEN_LITHERITE_SPEAR,
                ModToolItems.FROZEN_LITHERITE_AXE,
                ...
                ModToolItems.FROSTBITTEN_LITHERITE_SPEAR,
                ModToolItems.FROSTBITTEN_LITHERITE_AXE,
