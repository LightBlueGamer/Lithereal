...
public class RiftSpawner extends Entity {
    ...
    enum RiftType {
        ...
        NORMAL,
        LARGE;
        public static final WeightedList<RiftType> WEIGHTED_RANDOM_VALUES = WeightedList.<RiftType>builder().add(SMALL, 4).add(NORMAL, 10).add(LARGE, 2).build();
        public static RiftType getRandom(RandomSource randomSource) {
            return WEIGHTED_RANDOM_VALUES.getRandom(randomSource).orElse(RiftType.NORMAL);
        }
