...
public abstract class Attack<E extends LivingEntity & AttackingEntity<E>> {
    ...
    public static <E extends LivingEntity & AttackingEntity<E>> Attack<E> loadSaveData(E attackingEntity, ValueInput valueInput) {
