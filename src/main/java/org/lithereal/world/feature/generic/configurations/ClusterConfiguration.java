...
public record ClusterConfiguration(int floorToCeilingSearchRange, IntProvider height, IntProvider radius,
    ...
    public static final Codec<ClusterConfiguration> CODEC = RecordCodecBuilder.create(
            instance -> instance.group(
                            ...
                            IntProviders.codec(1, 128).fieldOf("height").forGetter(clusterConfiguration -> clusterConfiguration.height),
                            IntProviders.codec(1, 128).fieldOf("radius").forGetter(clusterConfiguration -> clusterConfiguration.radius),
                            Codec.intRange(0, 64)
                            ...
                            FloatProviders.codec(0.0F, 2.0F).fieldOf("density").forGetter(clusterConfiguration -> clusterConfiguration.density),
                            FloatProviders.codec(0.0F, 2.0F).fieldOf("wetness").forGetter(clusterConfiguration -> clusterConfiguration.wetness),
