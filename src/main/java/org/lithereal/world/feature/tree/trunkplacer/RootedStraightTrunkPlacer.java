...
public class RootedStraightTrunkPlacer extends TrunkPlacer {
    ...
    public @NotNull List<FoliagePlacer.FoliageAttachment> placeTrunk(
        ...
        placeBelowTrunkBlock(worldGenLevel, biConsumer, randomSource, blockPos.below(), treeConfiguration);

        for (int offset = 0; offset < height; offset++) {
            this.placeLog(worldGenLevel, biConsumer, randomSource, blockPos.above(offset), treeConfiguration);
        }
