...
public class InfusedHammerItem extends HammerItem implements InfusedItem {
    public InfusedHammerItem(ToolMaterial toolMaterial, int damage, float attackSpeed, int weaponLevel, Properties properties) {
        super(toolMaterial, damage, attackSpeed, weaponLevel, Ability.INFUSED.createToolComponent(properties));
    }
