...
public class AbilityHoeItem extends HoeItem implements AbilityItem {
    final Ability ability;
    public AbilityHoeItem(Ability ability, ToolMaterial toolMaterial, Properties properties) {
        super(toolMaterial, -toolMaterial.attackDamageBonus(), 0, properties);
