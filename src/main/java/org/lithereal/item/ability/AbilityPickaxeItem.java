...
public class AbilityPickaxeItem extends Item implements AbilityItem {
    final Ability ability;
    public AbilityPickaxeItem(Ability ability, ToolMaterial toolMaterial, Properties properties) {
        super(properties.pickaxe(toolMaterial, 1, -2.8f));
