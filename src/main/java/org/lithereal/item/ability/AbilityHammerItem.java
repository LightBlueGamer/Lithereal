...
public class AbilityHammerItem extends HammerItem implements AbilityItem {
    ...
    public AbilityHammerItem(Ability ability, ToolMaterial toolMaterial, int damage, float attackSpeed, int weaponLevel, Properties properties) {
        super(toolMaterial, damage, attackSpeed, weaponLevel, properties);
