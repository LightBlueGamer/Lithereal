...
public class AbilitySwordItem extends Item implements AbilityItem {
    final Ability ability;
    public AbilitySwordItem(Ability ability, ToolMaterial toolMaterial, Properties properties) {
        super(properties.sword(toolMaterial, 3, -2.4f));
