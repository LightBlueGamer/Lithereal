...
public class ModComponents {
    ...
    public static final RegistrySupplier<DataComponentType<MultiMiner>> MULTI_MINER = register("multi_miner", builder -> builder.persistent(MultiMiner.CODEC));
    public static final RegistrySupplier<DataComponentType<Smelter>> SMELTER = register("smelter", builder -> builder.ignoreSwapAnimation().persistent(Smelter.CODEC));
