...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        basicItem(ModRawMaterialItems.LITHERITE_CRYSTAL.get());
    ...
    public void bowItem(Item bowItem) {
        Identifier location = BuiltInRegistries.ITEM.getKey(bowItem);
        ItemModelBuilder builder = baseBow(location);
        builder.override().model(baseBow(location.withSuffix("_pulling_0")))
                .predicate(Identifier.withDefaultNamespace("pulling"), 1);
        builder.override().model(baseBow(location.withSuffix("_pulling_1")))
                .predicate(Identifier.withDefaultNamespace("pulling"), 1)
                .predicate(Identifier.withDefaultNamespace("pull"), 0.65F);
        builder.override().model(baseBow(location.withSuffix("_pulling_2")))
                .predicate(Identifier.withDefaultNamespace("pulling"), 1)
                .predicate(Identifier.withDefaultNamespace("pull"), 0.9F);
    }
    public ItemModelBuilder baseBow(Identifier item) {
