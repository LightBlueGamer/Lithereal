...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    public void generate() {
        ...
        dropSelf(ModStoneBlocks.ETHERSTONE_BUTTON.get());
        dropSelf(ModStoneBlocks.ETHERSTONE_PRESSURE_PLATE.get());
        ...
        dropSelf(ModStoneBlocks.ETHERSTONE_BRICK_BUTTON.get());
        dropSelf(ModStoneBlocks.ETHERSTONE_BRICK_PRESSURE_PLATE.get());
        ...
        dropSelf(ModStoneBlocks.LUMINITE_BUTTON.get());
        dropSelf(ModStoneBlocks.LUMINITE_PRESSURE_PLATE.get());
        ...
        dropSelf(ModStoneBlocks.VERDONE_BUTTON.get());
        dropSelf(ModStoneBlocks.VERDONE_PRESSURE_PLATE.get());
