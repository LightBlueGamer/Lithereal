...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(@NotNull RecipeOutput recipeOutput) {
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.PASSIVE_ETHER_ABSORBER.get(), 1)
                ...
                .save(recipeOutput);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.ELECTRIC_CRUCIBLE.get(), 1)
        ...
        swordItem(recipeOutput, Items.STICK, ModRawMaterialItems.LITHERITE_CRYSTAL.get(), ModToolItems.LITHERITE_SWORD.get());
        ...
        pickaxeItem(recipeOutput, Items.STICK, ModRawMaterialItems.LITHERITE_CRYSTAL.get(), ModToolItems.LITHERITE_PICKAXE.get());
        ...
        axeItem(recipeOutput, Items.STICK, ModRawMaterialItems.LITHERITE_CRYSTAL.get(), ModToolItems.LITHERITE_AXE.get());
        ...
        shovelItem(recipeOutput, Items.STICK, ModRawMaterialItems.LITHERITE_CRYSTAL.get(), ModToolItems.LITHERITE_SHOVEL.get());
        ...
        hoeItem(recipeOutput, Items.STICK, ModRawMaterialItems.LITHERITE_CRYSTAL.get(), ModToolItems.LITHERITE_HOE.get());
        ...
        hammerItem(recipeOutput, Items.STICK, ModRawMaterialItems.LITHERITE_CRYSTAL.get(), ModToolItems.LITHERITE_HAMMER.get());
        ...
        helmetItem(recipeOutput, ModRawMaterialItems.LITHERITE_CRYSTAL.get(), ModArmorItems.LITHERITE_HELMET.get());
        ...
        chestplateItem(recipeOutput, ModRawMaterialItems.LITHERITE_CRYSTAL.get(), ModArmorItems.LITHERITE_CHESTPLATE.get());
        ...
        leggingsItem(recipeOutput, ModRawMaterialItems.LITHERITE_CRYSTAL.get(), ModArmorItems.LITHERITE_LEGGINGS.get());
        ...
        bootsItem(recipeOutput, ModRawMaterialItems.LITHERITE_CRYSTAL.get(), ModArmorItems.LITHERITE_BOOTS.get());
        ...
        oreDual(recipeOutput, List.of(ModOreBlocks.LITHERITE_ORE.get(), ModOreBlocks.DEEPSLATE_LITHERITE_ORE.get(), ModOreBlocks.ETHERSTONE_LITHERITE_ORE.get()), RecipeCategory.MISC, ModRawMaterialItems.LITHERITE_CRYSTAL.get(), 1, 200, "litherite_crystal");
        ...
        nineBlockStorageRecipesWithCustomUnpackingFromBaseModNamespace(
                recipeOutput, RecipeCategory.MISC, ModRawMaterialItems.LITHERITE_CRYSTAL.get(), RecipeCategory.MISC, ModStorageBlocks.LITHERITE_BLOCK.get(), "litherite_crystal_from_block", "litherite_crystal"
        );
        nineBlockStorageRecipesWithCustomUnpackingFromBaseModNamespace(
                recipeOutput, RecipeCategory.MISC, ModRawMaterialItems.BURNING_LITHERITE_CRYSTAL.get(), RecipeCategory.MISC, ModStorageBlocks.BURNING_LITHERITE_BLOCK.get(), "burning_litherite_crystal_from_block", "burning_litherite_crystal"
        );
        nineBlockStorageRecipesWithCustomUnpackingFromBaseModNamespace(
                recipeOutput, RecipeCategory.MISC, ModRawMaterialItems.FROZEN_LITHERITE_CRYSTAL.get(), RecipeCategory.MISC, ModStorageBlocks.FROZEN_LITHERITE_BLOCK.get(), "frozen_litherite_crystal_from_block", "frozen_litherite_crystal"
        );
        nineBlockStorageRecipesWithCustomUnpackingFromBaseModNamespace(
                recipeOutput, RecipeCategory.MISC, ModRawMaterialItems.INFUSED_LITHERITE_INGOT.get(), RecipeCategory.MISC, ModStorageBlocks.INFUSED_LITHERITE_BLOCK.get(), "infused_litherite_ingot_from_block", "infused_litherite_ingot"
        );
        nineBlockStorageRecipesWithCustomUnpackingFromBaseModNamespace(
                recipeOutput, RecipeCategory.MISC, ModRawMaterialItems.WITHERING_LITHERITE_CRYSTAL.get(), RecipeCategory.MISC, ModStorageBlocks.WITHERING_LITHERITE_BLOCK.get(), "withering_litherite_crystal_from_block", "withering_litherite_crystal"
        );
        nineBlockStorageRecipesWithCustomUnpackingFromBaseModNamespace(
                recipeOutput, RecipeCategory.MISC, ModRawMaterialItems.CHARGED_LITHERITE_CRYSTAL.get(), RecipeCategory.MISC, ModStorageBlocks.CHARGED_LITHERITE_BLOCK.get(), "charged_litherite_crystal_from_block", "charged_litherite_crystal"
        );
        nineBlockStorageRecipesWithCustomUnpackingFromBaseModNamespace(
                recipeOutput, RecipeCategory.MISC, ModRawMaterialItems.ODYSIUM_INGOT.get(), RecipeCategory.MISC, ModStorageBlocks.ODYSIUM_BLOCK.get(), "odysium_ingot_from_block", "odysium_ingot"
        );
        nineBlockStorageRecipesWithCustomUnpackingFromBaseModNamespace(
                recipeOutput, RecipeCategory.MISC, ModRawMaterialItems.PHANTOM_DIAMOND.get(), RecipeCategory.MISC, ModPhantomBlocks.PHANTOM_DIAMOND_BLOCK.get(), "phantom_diamond_from_block", "phantom_diamond"
        );
        nineBlockStorageRecipesWithCustomUnpackingFromBaseModNamespace(
                recipeOutput, RecipeCategory.MISC, ModRawMaterialItems.IMPURE_ETHEREAL_CRYSTAL_SHARD.get(), RecipeCategory.MISC, ModBlocks.ETHEREAL_CRYSTAL_BLOCK.get(), "impure_ethereal_crystal_shard_from_block", "impure_ethereal_crystal_shard"
        );
        ...
        twoByTwoPacker(
                recipeOutput, RecipeCategory.MISC, ModBlocks.LITHERITE_CRYSTAL_BLOCK.get(), ModRawMaterialItems.LITHERITE_CRYSTAL.get()
        );
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModRawMaterialItems.LITHERITE_CRYSTAL.get(), 4)
