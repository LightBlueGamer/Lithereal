...
public class ModTags {
    ...
    public static final TagKey<Item> FROZEN_LITHERITE_REPAIR_ITEMS = createItemTag("frozen_litherite_repair_items");
    ...
    public static final TagKey<Potion> DISPELS_FIRE = createPotionTag("dispels_fire");
    public static TagKey<Potion> createPotionTag(String name) {
        return create(name, Registries.POTION);
    }
