...
public class ModOreBlocks {
    public static final RegistrySupplier<Block> LITHERITE_ORE = registerBlock("litherite_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(2, 6), BlockBehaviour.Properties.of().setId(resourceKey)
    ...
    public static final RegistrySupplier<Block> NERITH_ORE = registerBlock("nerith_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(4,7), BlockBehaviour.Properties.of().setId(resourceKey)
    ...
    public static final RegistrySupplier<Block> ETHERSTONE_NERITH_ORE = registerBlock("etherstone_nerith_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(4,7), BlockBehaviour.Properties.ofLegacyCopy(ModOreBlocks.DEEPSLATE_NERITH_ORE.get()).setId(resourceKey)));

    public static final RegistrySupplier<Block> LUMINIUM_ORE = registerBlock("luminium_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(1, 6), BlockBehaviour.Properties.of().setId(resourceKey)
                    .strength(3f).requiresCorrectToolForDrops().explosionResistance(25)));
    ...
    public static final RegistrySupplier<Block> ETHERSTONE_LUMINIUM_ORE = registerBlock("etherstone_luminium_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(1, 6), BlockBehaviour.Properties.ofLegacyCopy(ModOreBlocks.DEEPSLATE_LUMINIUM_ORE.get()).setId(resourceKey)));

    public static final RegistrySupplier<Block> CYRUM_ORE = registerBlock("cyrum_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(0, 3), BlockBehaviour.Properties.of().setId(resourceKey)
                    .strength(3f).requiresCorrectToolForDrops().explosionResistance(25)));
    ...
    public static final RegistrySupplier<Block> ETHERSTONE_CYRUM_ORE = registerBlock("etherstone_cyrum_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(0, 3), BlockBehaviour.Properties.ofLegacyCopy(ModOreBlocks.DEEPSLATE_CYRUM_ORE.get()).setId(resourceKey)));

    public static final RegistrySupplier<Block> COPALITE_ORE = registerBlock("copalite_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(3, 9), BlockBehaviour.Properties.of().setId(resourceKey)
                    .strength(3f).requiresCorrectToolForDrops().explosionResistance(25)));
    ...
    public static final RegistrySupplier<Block> ETHERSTONE_COPALITE_ORE = registerBlock("etherstone_copalite_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(3, 9), BlockBehaviour.Properties.ofLegacyCopy(ModOreBlocks.DEEPSLATE_COPALITE_ORE.get()).setId(resourceKey)));

    public static final RegistrySupplier<Block> AURELITE_ORE = registerBlock("aurelite_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(0, 2), BlockBehaviour.Properties.of().setId(resourceKey)
                    .strength(3f).requiresCorrectToolForDrops().explosionResistance(25)));
    ...
    public static final RegistrySupplier<Block> ETHERSTONE_AURELITE_ORE = registerBlock("etherstone_aurelite_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(0, 2), BlockBehaviour.Properties.ofLegacyCopy(ModOreBlocks.DEEPSLATE_AURELITE_ORE.get()).setId(resourceKey)));

    public static final RegistrySupplier<Block> SATURNITE_ORE = registerBlock("saturnite_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(5, 10), BlockBehaviour.Properties.of().setId(resourceKey)
                    .strength(3f).requiresCorrectToolForDrops().explosionResistance(25)));

    public static final RegistrySupplier<Block> PAILITE_SATURNITE_ORE = registerBlock("pailite_saturnite_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(0, 3), BlockBehaviour.Properties.of().setId(resourceKey)
                    .strength(3f).requiresCorrectToolForDrops().explosionResistance(25)));
    ...
    public static final RegistrySupplier<Block> PAILITE_HELLIONITE_ORE = registerBlock("pailite_hellionite_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(0, 3), BlockBehaviour.Properties.of().setId(resourceKey)
                    .strength(3f).requiresCorrectToolForDrops().explosionResistance(25)));
    ...
    public static final RegistrySupplier<Block> ALLIAN_ORE = registerBlock("allian_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(4, 8), BlockBehaviour.Properties.of().setId(resourceKey)
                    .strength(5f).requiresCorrectToolForDrops().explosionResistance(25)));

    public static final RegistrySupplier<Block> PAILITE_NETHERITE_ORE = registerBlock("pailite_netherite_ore",
            resourceKey -> new DropExperienceBlock(UniformInt.of(4, 6), BlockBehaviour.Properties.of().setId(resourceKey)
                    .strength(3f).requiresCorrectToolForDrops().explosionResistance(25)),
