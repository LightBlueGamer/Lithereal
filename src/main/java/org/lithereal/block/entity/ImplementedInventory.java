...
public interface ImplementedInventory extends WorldlyContainer {
    ...
    default void saveItems(@NotNull ValueOutput valueOutput) {
        ContainerHelper.saveAllItems(valueOutput, getItems());
    }

    default void loadItems(@NotNull ValueInput valueInput) {
