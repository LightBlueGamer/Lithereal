...
neoForge {
    ...
    runs {
        ...
        register("data") {
            ...
            programArguments.addAll("--mod", rootProject.property("mod.id") as String, "--all", "--output", file("$rootDir/src/main/generated/resources/").getAbsolutePath(), "--existing", file("src/main/resources/").getAbsolutePath())
        }
        register("server") {
            gameDirectory = file("run/")
            server()
