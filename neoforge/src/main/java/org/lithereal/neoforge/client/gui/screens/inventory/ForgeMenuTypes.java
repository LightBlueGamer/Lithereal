...
public class ForgeMenuTypes {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<ElectricCrucibleMenu>> ELECTRIC_CRUCIBLE_MENU =
            registerMenuType(ForgeElectricCrucibleMenu::create, "electric_crucible_menu");
