...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        add(ModOreBlocks.LITHERITE_ORE.get(), block -> createMultipleOreDrops(block, ForgeItems.LITHERITE_CRYSTAL.get(), 1, 2));
        add(ModOreBlocks.DEEPSLATE_LITHERITE_ORE.get(), block -> createMultipleOreDrops(block, ForgeItems.LITHERITE_CRYSTAL.get(), 1, 2));
        add(ModOreBlocks.ETHERSTONE_LITHERITE_ORE.get(), block -> createMultipleOreDrops(block, ForgeItems.LITHERITE_CRYSTAL.get(), 1, 2));
