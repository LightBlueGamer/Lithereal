...
import org.lithereal.neoforge.client.gui.screens.inventory.ForgeElectricCrucibleMenu;

import java.util.concurrent.atomic.AtomicInteger;

public class ForgeElectricCrucibleBlockEntity extends ElectricCrucibleBlockEntity implements NeoForgeInventory {
    private final ImplementedItemHandler itemHandler = new ImplementedItemHandler(4, this);
    public ForgeElectricCrucibleBlockEntity(BlockPos pos, BlockState state) {
        super(pos, state);
    }

    @Override
    public @Nullable AbstractContainerMenu createMenu(int i, Inventory inventory, Player player) {
        return new ForgeElectricCrucibleMenu(i, inventory, this);
    }
