package org.lithereal.world.item.infused;
...
import org.lithereal.world.item.ability.AbilityPickaxeItem;

import java.util.List;
import java.util.Objects;

public class InfusedLitheritePickaxeItem extends AbilityPickaxeItem implements InfusedItem {
    public InfusedLitheritePickaxeItem(Tier tier, Properties properties) {
