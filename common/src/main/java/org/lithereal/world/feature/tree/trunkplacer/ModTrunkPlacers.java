...
public class ModTrunkPlacers {
    ...
    public static final RegistrySupplier<TrunkPlacerType<MegaStraightTrunkPlacer>> MEGA_STRAIGHT = registerTrunkPlacerType("mega_straight_trunk_placer", () -> new TrunkPlacerType<>(MegaStraightTrunkPlacer.CODEC));
