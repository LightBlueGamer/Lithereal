...
public class ModToolItems {
    ...
    public static final RegistrySupplier<Item> ODYSIUM_BOW = ITEMS.register("odysium_bow", () ->
            new ModBowItem(ODYSIUM, new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON), 2, 0.2F, 1));

    public static final RegistrySupplier<Item> ENHANCED_ODYSIUM_BOW = ITEMS.register("enhanced_odysium_bow", () ->
            new ModBowItem(ODYSIUM, new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON), 3, 0.1F, 1.5F));
