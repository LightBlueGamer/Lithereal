...
public class AbilityHammer extends Hammer implements AbilityItem {
    final Ability ability;
    public AbilityHammer(Ability ability, Tier tier, int damage, float attackSpeed, Properties properties) {
