...
public class ModComponents {
    ...
    public static final RegistrySupplier<DataComponentType<Boolean>> ENHANCED = register("enhanced", (builder) -> builder.persistent(Codec.BOOL).networkSynchronized(ByteBufCodecs.BOOL));
