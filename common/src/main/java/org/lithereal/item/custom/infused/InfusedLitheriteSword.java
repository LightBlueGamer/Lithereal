...
import org.lithereal.item.custom.ability.AbilitySword;

import java.util.List;
import java.util.Objects;

public class InfusedLitheriteSword extends AbilitySword implements InfusedItem {
    public InfusedLitheriteSword(Tier tier, Properties properties) {
