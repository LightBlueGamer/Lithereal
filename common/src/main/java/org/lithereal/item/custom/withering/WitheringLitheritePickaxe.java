...
public class WitheringLitheritePickaxe extends PickaxeItem {
    public WitheringLitheritePickaxe(Tier tier, int damage, float attackSpeed, Properties properties) {
