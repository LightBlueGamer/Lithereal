...
public class WitheringLitheritePickaxeItem extends PickaxeItem {
    public WitheringLitheritePickaxeItem(Tier tier, int damage, float attackSpeed, Properties properties) {
