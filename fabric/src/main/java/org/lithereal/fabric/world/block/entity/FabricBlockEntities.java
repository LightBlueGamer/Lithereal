...
public class FabricBlockEntities {
    ...
    public static final BlockEntityType<FabricElectricCrucibleBlockEntity> ELECTRIC_CRUCIBLE_BLOCK_ENTITY =
            Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Lithereal.MOD_ID, "electric_crucible_block"),
    ...
    public static final BlockEntityType<FabricFireCrucibleBlockEntity> FIRE_CRUCIBLE_BLOCK_ENTITY =
            Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Lithereal.MOD_ID, "fire_crucible_block"),
    ...
    public static final BlockEntityType<FabricFreezingStationBlockEntity> FREEZING_STATION_BLOCK_ENTITY =
            Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Lithereal.MOD_ID, "freezing_station_block"),
    ...
    public static final BlockEntityType<FabricInfusementChamberBlockEntity> INFUSEMENT_CHAMBER_BLOCK_ENTITY =
            Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Lithereal.MOD_ID, "infusement_chamber_block"),
