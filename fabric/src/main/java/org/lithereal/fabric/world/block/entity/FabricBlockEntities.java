...
public class FabricBlockEntities {
    ...
    public static final BlockEntityType<FabricEtherBatteryBlockEntity> ETHER_BATTERY_BLOCK_ENTITY =
            Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Lithereal.MOD_ID, "ether_battery_block_entity"),
    ...
    public static final BlockEntityType<FabricEtherCollectorBlockEntity> ETHER_COLLECTOR_BLOCK_ENTITY =
            Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Lithereal.MOD_ID, "ether_collector_block_entity"),
